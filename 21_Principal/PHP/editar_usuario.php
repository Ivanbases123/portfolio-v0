<?php 
include 'get_editar_usuario.php';
...
<head>
  ...
  <link rel="stylesheet" href="../CSS/styles_editar_usuario.css">
  ...
  <div class="dashboard">
    ...
    <div class="main-wrapper">
      ...
      <main class="main-content">
        <form method="POST" action="procesar_editar_usuario.php" class="formulario-usuario">
